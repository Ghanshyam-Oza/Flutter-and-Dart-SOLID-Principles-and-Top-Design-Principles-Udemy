...
class StatePatternHome extends StatefulWidget {
  const StatePatternHome({Key? key}) : super(key: key);

  @override
  State<StatePatternHome> createState() => _StatePatternHomeState();
}
...
///
class _StatePatternHomeState extends State<StatePatternHome> {
